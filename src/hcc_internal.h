...
#define HCC_ENABLE_WORKER_LOGGING 0
#endif
...
uintptr_t hcc_virt_mem_page_size(void);
...
uintptr_t hcc_virt_mem_reserve_align(void);
...
enum HccCompoundDataTypeKind {
	...
	HCC_COMPOUND_DATA_TYPE_KIND_PIXEL_STATE,
};
...
enum {
	...
	HCC_VERTEX_SHADER_PARAM_VERTEX_SV_OUT,
	HCC_VERTEX_SHADER_PARAM_BC,
	HCC_VERTEX_SHADER_PARAM_RASTERIZER_STATE,
};

enum {
	HCC_PIXEL_SHADER_PARAM_PIXEL_SV,
	HCC_PIXEL_SHADER_PARAM_PIXEL_SV_OUT,
	HCC_PIXEL_SHADER_PARAM_BC,
	HCC_PIXEL_SHADER_PARAM_RASTERIZER_STATE,
	HCC_PIXEL_SHADER_PARAM_PIXEL_STATE,
};
...
enum {
	HCC_VERTEX_SV_OUT_POSITION,
};

enum {
	HCC_PIXEL_SV_PIXEL_COORD,
};

enum {
	HCC_PIXEL_SV_OUT_DEPTH,
};
...
void hcc_swizzle_extract_indices(HccSwizzle swizzle, uint32_t* indices); // indices[4]
...
enum HccPPPredefinedMacro {
	...
	HCC_PP_PREDEFINED_MACRO___HCC_MAC_OS__,
...
enum {
	...
	HCC_ASTGEN_SPECIFIER_PIXEL_STATE,
	HCC_ASTGEN_SPECIFIER_INTERP,
	HCC_ASTGEN_SPECIFIER_NOINTERP,

	HCC_ASTGEN_SPECIFIER_VERTEX,
	HCC_ASTGEN_SPECIFIER_PIXEL,
...
enum {
	...
	HCC_ASTGEN_SPECIFIER_FLAGS_PIXEL_STATE =         1 << HCC_ASTGEN_SPECIFIER_PIXEL_STATE,
	HCC_ASTGEN_SPECIFIER_FLAGS_INTERP =              1 << HCC_ASTGEN_SPECIFIER_INTERP,
	...
	HCC_ASTGEN_SPECIFIER_FLAGS_PIXEL =               1 << HCC_ASTGEN_SPECIFIER_PIXEL,
	HCC_ASTGEN_SPECIFIER_FLAGS_COMPUTE =             1 << HCC_ASTGEN_SPECIFIER_COMPUTE,

	HCC_ASTGEN_SPECIFIER_FLAGS_ALL_SHADER_STAGES = HCC_ASTGEN_SPECIFIER_FLAGS_VERTEX | HCC_ASTGEN_SPECIFIER_FLAGS_PIXEL | HCC_ASTGEN_SPECIFIER_FLAGS_COMPUTE,
	...
	HCC_ASTGEN_SPECIFIER_FLAGS_ALL_STRUCT_SPECIFIERS =
		...
		HCC_ASTGEN_SPECIFIER_FLAGS_PIXEL_STATE       ,
	HCC_ASTGEN_SPECIFIER_FLAGS_ALL_STRUCT_FIELD_SPECIFIERS = HCC_ASTGEN_SPECIFIER_FLAGS_INTERP | HCC_ASTGEN_SPECIFIER_FLAGS_NOINTERP,
...
enum {
	...
	HCC_ASTGEN_TYPE_SPECIFIER_FLOAT_TYPES =
		HCC_ASTGEN_TYPE_SPECIFIER_HALF    |
		HCC_ASTGEN_TYPE_SPECIFIER_FLOAT   |
		HCC_ASTGEN_TYPE_SPECIFIER_DOUBLE  ,
...
enum {
	...
	HCC_SPIRV_OP_DPDX_FINE = 210,
	HCC_SPIRV_OP_DPDY_FINE = 211,
	HCC_SPIRV_OP_FWIDTH_FINE = 212,
	HCC_SPIRV_OP_DPDX_COARSE = 213,
	HCC_SPIRV_OP_DPDY_COARSE = 214,
	HCC_SPIRV_OP_FWIDTH_COARSE = 215,
	HCC_SPIRV_OP_CONTROL_BARRIER = 224,
	HCC_SPIRV_OP_MEMORY_BARRIER = 225,
	HCC_SPIRV_OP_ATOMIC_LOAD = 227,
	HCC_SPIRV_OP_ATOMIC_STORE = 228,
	HCC_SPIRV_OP_ATOMIC_EXCHANGE = 229,
	HCC_SPIRV_OP_ATOMIC_COMPARE_EXCHANGE = 230,
	HCC_SPIRV_OP_ATOMIC_I_ADD = 234,
	HCC_SPIRV_OP_ATOMIC_I_SUB = 235,
	HCC_SPIRV_OP_ATOMIC_S_MIN = 236,
	...
	HCC_SPIRV_OP_GROUP_NON_UNIFORM_ELECT = 333,
	HCC_SPIRV_OP_GROUP_NON_UNIFORM_ALL = 334,
	HCC_SPIRV_OP_GROUP_NON_UNIFORM_ANY = 335,
	HCC_SPIRV_OP_GROUP_NON_UNIFORM_ALL_EQUAL = 336,
	HCC_SPIRV_OP_GROUP_NON_UNIFORM_BALLOT = 339,
	HCC_SPIRV_OP_GROUP_NON_UNIFORM_BALLOT_BIT_COUNT = 340,
	HCC_SPIRV_OP_GROUP_NON_UNIFORM_SHUFFLE = 345,
	HCC_SPIRV_OP_GROUP_NON_UNIFORM_I_ADD = 349,
	HCC_SPIRV_OP_GROUP_NON_UNIFORM_F_ADD = 350,
	HCC_SPIRV_OP_GROUP_NON_UNIFORM_I_MUL = 351,
	HCC_SPIRV_OP_GROUP_NON_UNIFORM_F_MUL = 352,
	HCC_SPIRV_OP_GROUP_NON_UNIFORM_S_MIN = 353,
	HCC_SPIRV_OP_GROUP_NON_UNIFORM_U_MIN = 354,
	HCC_SPIRV_OP_GROUP_NON_UNIFORM_F_MIN = 355,
	HCC_SPIRV_OP_GROUP_NON_UNIFORM_S_MAX = 356,
	HCC_SPIRV_OP_GROUP_NON_UNIFORM_U_MAX = 357,
	HCC_SPIRV_OP_GROUP_NON_UNIFORM_F_MAX = 358,
	HCC_SPIRV_OP_GROUP_NON_UNIFORM_BITWISE_AND = 359,
	HCC_SPIRV_OP_GROUP_NON_UNIFORM_BITWISE_OR = 360,
...
enum {
	...
	HCC_SPIRV_GLSL_STD_450_OP_FIND_I_LSB = 73,
	HCC_SPIRV_GLSL_STD_450_OP_FIND_U_MSB = 75,
};
...
enum {
	...
	HCC_SPIRV_CAPABILITY_DEMOTE_HELPER_INVOCATION = 5379,
...
enum {
	...
	HCC_SPIRV_STORAGE_CLASS_WORK_GROUP = 4,
...
enum {
	HCC_SPIRV_DECORATION_BLOCK = 2,
	HCC_SPIRV_DECORATION_ARRAY_STRIDE = 6,
	...
	HCC_SPIRV_DECORATION_OFFSET = 35,
};
...
enum {
	...
	HCC_SPIRV_BUILTIN_SUBGROUP_LOCAL_INVOCATION_ID = 41,
...
enum {
	HCC_SPIRV_SCOPE_CROSS_DEVICE = 0,
	HCC_SPIRV_SCOPE_DEVICE =       1,
	HCC_SPIRV_SCOPE_WORK_GROUP =   2,
	HCC_SPIRV_SCOPE_SUB_GROUP =    3,
	HCC_SPIRV_SCOPE_INVOCATION =   4,
};
...
enum {
	...
	HCC_SPIRV_MEMORY_SEMANTICS_IMAGE_MEMORY =      0x800,
};

enum {
	HCC_SPIRV_GROUP_OPERATION_REDUCE =         0,
	HCC_SPIRV_GROUP_OPERATION_INCLUSIVE_SCAN = 1,
	HCC_SPIRV_GROUP_OPERATION_EXCLUSIVE_SCAN = 2,
};
...
enum { // some hardcoded SPIR-V ids
	...
	HCC_SPIRV_ID_VARIABLE_INPUT_SUBGROUP_LOCAL_INVOCATION_ID,
...
typedef struct HccSPIRVDescriptorBindingEntry HccSPIRVDescriptorBindingEntry;
struct HccSPIRVDescriptorBindingEntry {
	HccSPIRVDescriptorBindingKey key;
	HccAtomic(HccSPIRVId)        variable_spirv_id;
};
...
#define HCC_STRING_ID_PREDEFINED_MACROS_END (HCC_STRING_ID_PREDEFINED_MACROS_START + HCC_PP_PREDEFINED_MACRO_COUNT)
	...
	HCC_STRING_ID_SWIZZLE_XYZW_START = HCC_STRING_ID_PREDEFINED_MACROS_END,
#define HCC_STRING_ID_SWIZZLE_XYZW_END (HCC_STRING_ID_SWIZZLE_XYZW_START + HCC_SWIZZLE_COUNT)

	HCC_STRING_ID_SWIZZLE_RGBA_START = HCC_STRING_ID_SWIZZLE_XYZW_END,
#define HCC_STRING_ID_SWIZZLE_RGBA_END (HCC_STRING_ID_SWIZZLE_RGBA_START + HCC_SWIZZLE_COUNT)

	HCC_STRING_ID_ONCE = HCC_STRING_ID_SWIZZLE_RGBA_END,
