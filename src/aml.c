...
const char* hcc_aml_op_code_strings[HCC_AML_OP_COUNT] = {
	...
	[HCC_AML_OP_RESOURCE_DESCRIPTOR_ADDR] = "RESOURCE_DESCRIPTOR_ADDR",
	[HCC_AML_OP_MIN] = "MIN",
	[HCC_AML_OP_MAX] = "MAX",
	[HCC_AML_OP_CLAMP] = "CLAMP",
	[HCC_AML_OP_SIGN] = "SIGN",
	[HCC_AML_OP_ABS] = "ABS",
	[HCC_AML_OP_BITLSB] = "BITLSB",
	[HCC_AML_OP_BITMSB] = "BITMSB",
	[HCC_AML_OP_BITCOUNT] = "BITCOUNT",
	[HCC_AML_OP_FMA] = "FMA",
	...
	[HCC_AML_OP_DISCARD_PIXEL] = "DISCARD_PIXEL",
	[HCC_AML_OP_DDX] = "DDX",
	[HCC_AML_OP_DDY] = "DDY",
	...
	[HCC_AML_OP_WAVE_THREAD_IS_FIRST] = "WAVE_THREAD_IS_FIRST",
	[HCC_AML_OP_WAVE_THREAD_IDX] = "WAVE_THREAD_IDX",
	...
	[HCC_AML_OP_MEMORY_BARRIER_DISPATCH_GROUP] = "MEMORY_BARRIER_DISPATCH_GROUP",
	[HCC_AML_OP_MEMORY_BARRIER_ALL] = "MEMORY_BARRIER_ALL",
	[HCC_AML_OP_CONTROL_BARRIER_RESOURCE] = "CONTROL_BARRIER_RESOURCE",
	[HCC_AML_OP_CONTROL_BARRIER_DISPATCH_GROUP] = "CONTROL_BARRIER_DISPATCH_GROUP",
	[HCC_AML_OP_CONTROL_BARRIER_ALL] = "CONTROL_BARRIER_ALL",
	[HCC_AML_OP_HPRINT_STRING] = "HPRINT_STRING",
	...
	[HCC_AML_OP_ADDR_TEXTURE] = "ADDR_TEXTURE",
...
bool hcc_aml_op_code_has_return_value[HCC_AML_OP_COUNT] = {
	...
	[HCC_AML_OP_RESOURCE_DESCRIPTOR_ADDR] = true,
	[HCC_AML_OP_MIN] = true,
	[HCC_AML_OP_MAX] = true,
	[HCC_AML_OP_CLAMP] = true,
	[HCC_AML_OP_SIGN] = true,
	[HCC_AML_OP_ABS] = true,
	[HCC_AML_OP_BITLSB] = true,
	[HCC_AML_OP_BITMSB] = true,
	[HCC_AML_OP_BITCOUNT] = true,
	[HCC_AML_OP_FMA] = true,
	...
	[HCC_AML_OP_DISCARD_PIXEL] = false,
	[HCC_AML_OP_DDX] = true,
	[HCC_AML_OP_DDY] = true,
	...
	[HCC_AML_OP_WAVE_THREAD_IS_FIRST] = true,
	[HCC_AML_OP_WAVE_THREAD_IDX] = true,
	...
	[HCC_AML_OP_MEMORY_BARRIER_DISPATCH_GROUP] = false,
	[HCC_AML_OP_MEMORY_BARRIER_ALL] = false,
	[HCC_AML_OP_CONTROL_BARRIER_RESOURCE] = false,
	[HCC_AML_OP_CONTROL_BARRIER_DISPATCH_GROUP] = false,
	[HCC_AML_OP_CONTROL_BARRIER_ALL] = false,
	[HCC_AML_OP_HPRINT_STRING] = false,
