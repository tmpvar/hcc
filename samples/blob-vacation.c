...
static const float BLOB_MIN_DIST = 0.f;
static const float BLOB_MAX_DIST = 100.f;
...
HCC_VERTEX void blob_vacation_vs(HccVertexSV const* const sv, HccVertexSVOut* const sv_out, BlobVacationBC const* addrsp(BC) const bc, void* const state_out) {
...
HCC_PIXEL void blob_vacation_ps(HccPixelSV const* const sv, HccPixelSVOut* const sv_out, BlobVacationBC const* addrsp(BC) const bc, void const* const state, BlobVacationPixel* const pixel_out) {
