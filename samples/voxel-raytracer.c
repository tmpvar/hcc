...
void voxel_raytracer_cs(HccComputeSV const* const sv, VoxelRaytracerBC const* addrsp(BC) const bc) {
	...
	HccRwTexture2D(FMT_8_8_8_8_UNORM) resource_cast_test = (HccRwTexture2D(FMT_8_8_8_8_UNORM))int32_cast_test;
